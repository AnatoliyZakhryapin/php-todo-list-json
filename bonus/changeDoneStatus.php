...
$index_todo_to_change_done = $_POST['indexTodoToChangeDone'];
...
//Cambiamo lo stato done al elemento in base al indice arrivato
$todos[$index_todo_to_change_done]['done'] = !$todos[$index_todo_to_change_done]['done'];
